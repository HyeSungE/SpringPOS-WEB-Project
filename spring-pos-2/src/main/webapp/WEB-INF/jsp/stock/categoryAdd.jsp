	...
	<div class="signup-form">
		<form action="categoryAdd" method="post" class="form-horizontal">
			...
			<div class="form-group row">
				<label class="col-form-label col-4">카테고리 코드</label>
				<div class="col-8">
					<input type="text" class="form-control" name="categoryCode"
						pattern="[A-Z]{3}" title="대문자 영어 3글자만 입력해주세요." placeholder="AAA"
						required="required">
			...
			<div class="form-group row">
				<label class="col-form-label col-4">카테고리 이름</label>
				<div class="col-8">
