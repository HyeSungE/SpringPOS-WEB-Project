			...
			<div class="table-title">
				...
				<div class="form-inline justify-content-end"
					...
					<button type="button" class="btn btn-primary ml-3" id="reset"
						onclick="location.href = '/pos/stock/receiving'" style="margin-right: 30px">전체</button>
					...
					<div class="form-group ml-3">
						<select class="form-control" id="searchCriteria" name='searchCriteria'
							...
							<option value="productCode">상품코드</option>
							<option value="receivingQuantity">상품명</option>
							<option value="receivingStartDate">입고신청일</option>
							<option value="receivingDate">입고일</option>
						...
						<tbody>
							<c:forEach items="${list}" var="receiving">
								<tr >
									...
									<td >
									<a class="edit" id="editIcon" title="수정" href="#" onclick="openPopup('/pos/stock/receiving/receivingEdit?receivingNo=${receiving.receivingNo}', '내역 수정',550, 600)">
										<i class="material-icons" >&#xE254;</i></a>|<a class="success" id="successIcon" title="완료" href="#"onclick="openPopup('receiving/success?receivingNo=${receiving.receivingNo}','입고 완료',550, 600)">
	...
	function performSort() {
		...
		if (sortCriteria == "noneSelectCriteria") {
			...
			window.location.href = "?sortCriteria="
					...
					+ "&sortOrder="
					+ sortOrder
					+ "&searchCriteria=${searchCriteria}&searchKeyword=${searchKeyword}&page=1";
...
$(document).ready(function() {
	  ...
	  $("select[name='searchCriteria']").change(function() {
	    ...
	    if (selectedCriteria === "receivingStartDate" || selectedCriteria === "receivingDate") {
